...
export const NogodLogo = () => (
  <svg width="64" height="64" viewBox="0 0 64 64" fill="none" style={{padding: '12px'}}>
    <g transform="scale(0.22 0.33) translate(-45 -32.75825)">
...
export const RocketLogo = () => (
  <img
    ...
    width={64}
    height={64}
    style={{ borderRadius: 12, objectFit: 'cover', background: '#800880' }}
  />
);
